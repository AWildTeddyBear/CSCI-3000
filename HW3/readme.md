# CSCI-3000 - Structured Programming II (C++) - Homework 3
...
* Credit to [BoGuu](https://github.com/BoGuu) for helping out with some logic here and there
* Credit to [ASCIIMator](https://www.asciimator.net) for being my source of actually decent ASCII (Will use it more)
