# CSCI-3000 - Structured Programming II (C++) - Homework 6
...
```
g++ -std=c++17 main.cpp complex.cpp -o out
```
...
* Credit to [BoGuu](https://github.com/BoGuu) for helping out a lot with logic with overloaders